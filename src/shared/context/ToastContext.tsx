...
export function ToastProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <ToastContext.Provider value={api}>
      ...
      <div
        className="pointer-events-none fixed left-0 right-0 z-[9999] flex flex-col-reverse items-center gap-2 px-4"
        style={{ bottom: 'max(88px, calc(env(safe-area-inset-bottom) + 72px))' }}
        aria-live="polite"
      >
