...
const txMeta: Record<string, { label: string; icon: typeof ArrowUpRight; color: string; sign: string }> = {
  ...
  airtime: { label: 'Airtime', icon: Smartphone, color: 'var(--foreground)', sign: '−' },
  data: { label: 'Mobile data', icon: Wifi, color: 'var(--foreground)', sign: '−' },
  electricity: { label: 'Electricity', icon: Zap, color: '#F59E0B', sign: '−' },
  cable: { label: 'TV & cable', icon: Tv, color: 'var(--foreground)', sign: '−' },
  betting: { label: 'Betting', icon: Trophy, color: 'var(--foreground)', sign: '−' },
  bill: { label: 'Bill payment', icon: Receipt, color: 'var(--foreground)', sign: '−' },
  giveaway: { label: 'Giveaway', icon: Gift, color: 'var(--positive)', sign: '' },
  request: { label: 'Payment request', icon: Link2, color: 'var(--foreground)', sign: '' },
  reward: { label: 'Reward', icon: Award, color: 'var(--positive)', sign: '+' },
