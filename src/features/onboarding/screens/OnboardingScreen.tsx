  ...
  if (phase !== 'slides') {
    return (
      <div className="flex flex-col h-full items-center justify-center px-8 relative overflow-hidden" style={{ background: 'var(--background)' }}>
        <ParticleField color="var(--primary)" />
        <GridOverlay color="var(--primary)" />
        <motion.div
            ...
            {[0, 1, 2, 3].map(i => (
              <motion.div
                ...
                animate={{
                  ...
                  borderColor: i < pin.length ? 'var(--primary)' : 'rgba(255,255,255,0.2)',
                }}
              ...
              {slide === slides.length - 1 && (
                ...
                >
                  ...
                  <button
                    ...
                    style={{ color: 'var(--muted-foreground)', fontSize: 14, fontWeight: 500 }}
                  >
