...
/** Bottom-sheet asset picker with search, used by Receive. */
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <p style={{ color: 'var(--foreground)', fontWeight: 700, fontSize: 16, marginBottom: 12 }}>Select asset to receive</p>
