  ...
  return (
    <div className="flex flex-col h-full" style={{ background: 'var(--background)' }}>
      ...
      <div className="flex items-center gap-3 px-4 pb-3" style={{ borderBottom: '1px solid var(--border)' }}>
        ...
        <motion.button whileTap={{ scale: 0.9 }} onClick={() => setShowPayment(true)} className="w-9 h-9 rounded-2xl flex items-center justify-center" style={{ background: 'var(--muted)' }}>
          ...
          <div key={msg.id} className={`flex ${msg.sender === 'me' ? 'justify-end' : 'justify-start'}`}>
            <div style={{ maxWidth: '75%' }}>
              {msg.type === 'payment' && msg.payment ? (
                ...
                >
                  <p style={{ color: msg.sender === 'me' ? 'var(--primary-foreground)' : 'var(--foreground)', fontSize: 14, lineHeight: 1.4 }}>
                    {msg.text}
                  </p>
                </div>
              )}
      ...
      <div className="px-4 pb-4 pt-2 glass-nav" style={{ borderTop: '1px solid var(--border)' }}>
        <div className="flex items-center gap-2">
          <motion.button whileTap={{ scale: 0.9 }} onClick={() => setShowPayment(true)} className="w-10 h-10 rounded-2xl flex items-center justify-center flex-shrink-0" style={{ background: 'var(--muted)' }}>
        ...
        {showPayment && (
          <>
            ...
            <motion.div
              ...
              style={{ background: 'var(--card)', border: '1px solid var(--border)', borderTop: '1px solid var(--border)' }}
            >
              ...
              <motion.button
                ...
                style={{
                  ...
                  color: amount && !sending ? 'var(--primary-foreground)' : 'var(--muted-foreground)',
