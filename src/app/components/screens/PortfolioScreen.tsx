...
import { cryptoAssets, portfolioChartData, portfolio, type Screen } from '../../data/mockData';
  ...
  return (
    <div className="flex flex-col h-full" style={{ background: 'var(--background)' }}>
      ...
      <div className="flex items-center gap-3 px-5 mb-5">
        ...
        <h2 style={{ color: 'var(--foreground)', fontWeight: 800 }}>Portfolio Analytics</h2>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-5">
        ...
        <div className="rounded-[20px] p-5 mb-4" style={{ background: 'var(--card)', border: '1px solid var(--border)' }}>
          ...
          <div className="flex items-center gap-3 mt-2 mb-4">
            <div className="flex items-center gap-1 px-2 py-1 rounded-lg" style={{ background: 'rgba(16,185,129,0.15)' }}>
              <TrendingUp size={12} style={{ color: '#10B981' }} />
              <span style={{ color: 'var(--primary)', fontSize: 12, fontWeight: 700 }}>+{format(portfolio.change24hUSD)} (24h)</span>
            </div>
            <div className="flex items-center gap-1 px-2 py-1 rounded-lg" style={{ background: 'rgba(16,185,129,0.15)' }}>
              <span style={{ color: '#10B981', fontSize: 12, fontWeight: 700 }}>+{portfolio.allTimeGainPct}% all-time</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          {[
            { label: 'Best Day', value: '+$621.40', sub: 'Jan 12, 2026', color: '#10B981' },
            { label: 'Worst Day', value: '-$234.20', sub: 'Mar 3, 2026', color: '#EF4444' },
            { label: 'Avg Daily Return', value: '+$31.20', sub: '0.35% per day', color: '#3B82F6' },
            { label: 'Sharpe Ratio', value: '1.84', sub: 'Good risk-adjusted', color: '#A78BFA' },
          ].map(stat => (
