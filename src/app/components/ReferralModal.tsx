      ...
      {open && (
        <>
          ...
          >
            ...
            <div className="rounded-[20px] p-5 mb-5 text-center" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.15), rgba(79,70,229,0.08))', border: '1px solid rgba(99,102,241,0.2)' }}>
              <p style={{ color: 'var(--primary)', fontWeight: 800, fontSize: 28 }}>{reward}</p>
            ...
            {copied && (
              <motion.div initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }} className="flex items-center justify-center gap-2">
                ...
                <span style={{ color: 'var(--primary)', fontSize: 13, fontWeight: 600 }}>Code copied to clipboard!</span>
              </motion.div>
            )}
          </motion.div>
        </>
